...
/* 
List * createList(int (* destroy)(void *), void (* print)(List *),int(*compare)(void*,void*), int capacity);
Input: (* destroy)(void *), (* print)(List *), int
Output: List *
Preconditions: destroy and print functions are defined by the module 
Postconditions: a list is created and returned, the destroy and compare functions are set as elements of the list, size is set to 0, capacity is set as the given capacity. returns NULL on unable to allocate memory
*/

List * createList(int (* destroy)(void *), void (* print)(void *),int capacity);
