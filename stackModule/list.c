...
{
    if (theList == NULL || data == NULL || theList->capacity == theList->size) //null variable passed in or the list is full
    {
        return NULL;
    }
...
{
    if (theList == NULL || data == NULL || theList->capacity == theList->size) //null variables were passed in or the list is full
    {
        return NULL;
    }
